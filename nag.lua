print("Hello world!")
-- You aren't able to reset so you may have to rejoin

local plr = game.Players.LocalPlayer;
local chr = plr.Character;
local hum = chr.Humanoid;
local hat = chr['Nagamaki'];
...
a1.Position = Vector3.new(.5, -1, 0);
a1.Orientation = Vector3.new(260, 1, 1);
...
Effects = {
	...
	Ring = {
		Create = function(brickcolor, cframe, x1, y1, z1, x3, y3, z3, delay)
			...
			prt.Anchored = true
			prt.CFrame = cframe
			local msh = CFuncs.Mesh.Create("SpecialMesh", prt, "FileMesh", "rbxassetid://", Vector3.new(0, 0, 0), Vector3.new(x1, y1, z1))
			game:GetService("Debris"):AddItem(prt, 10)
			table.insert(Effects, {
				prt,
				"Cylinder",
...
PMesh.MeshId = "rbxassetid://"
PMesh.TextureId = "rbxassetid://"
